...
\begin{itemize} \itemsep -2pt % Reduce space between items
\item Replaced k-means clustering used in paper {\sl Sketch-Based Shape Retrieval} with different clustering methods including k-medoids and fitting Spherical Gaussians with EM algorithm.
